...
class RequestBuilder(private val baseUrl: String, private val apiKey: String) {
    ...
    fun detailsRequest(topicId: Int): Request = createGetRequest(detailsEndpoint(topicId))
    ...
    private fun detailsEndpoint(topicId: Int): HttpUrl = buildHttpUrl("t/$topicId.json")
